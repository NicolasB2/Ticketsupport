<template>
  <div class="content">
    <div class="col-md-8 ml-auto mr-auto">
      <h2 class="text-center">Enterprises</h2>
     
    </div>
    <div class="row mt-5">
      <div class="col-12">
        <card card-body-classes="table-full-width">
          <h4 slot="header" class="card-title">Enterprises</h4>
          <div>
            <div class="row">
              <div class="col-md-4">
                  <base-input>
...
export default {
  ...
  methods: {
    ...
    handleEdit(row) {
     ...
     this.$router.push("/editEnterprise/" + row.nit);
    ...
    handleDelete(row) {
      swal({
        ...
        if (result.value) {
          this.deleteRow(row);
          apiMedved.deleteEnterprise(row.nit);
          this.$router.go();
        }
      });
    },
